...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: MkwY5WfkrLgP/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__euKo)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___7Lp8)}
              role={"img"}
            />
          ),
